...
<?php
if (isset($stuNo) && isset($stuName) && isset($pwd) && isset($className) && isset($sex) && isset($mobile) && isset($email) && isset($photo)) {
    $sql="INSERT INTO student VALUES ('$stuNo', '$stName', ' $pwd', '20203514', '', '', null, null)";
    $result = $db->query($sql);
}
// if($result){
